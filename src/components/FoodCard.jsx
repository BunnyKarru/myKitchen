...
function FoodCard({ image, name, category, id }) {
  ...
  return (
    <Link to='/foodItem'>
      <div
        className="w-full sm:w-full md:max-w-xs bg-white shadow-lg rounded-lg overflow-hidden m-4 h-80 shadow-orange-100 hover:shadow-xl transform transition-transform hover:scale-105 duration-300"
